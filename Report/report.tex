...
\section{Méthode par FFT}
	...
	\subsection{Implémentation sur Matlab}
		...
		\subsubsection{Signaux générés}
			Le signal que nous avons généré est une somme de sinusoïdes : $s(t) = sin(2\pif_0 t) + sin(2\pif_1 t)$ avec $f_0 = 30$ Hz et $f_1 = 200$ Hz.
			\begin{figure}[h]
				\centering
			...
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item \textbf{Cas complexe :}
						...
						\]
				\end{itemize}
				Ce qui nous donne $\boxed{|a_2| < 1}$ et $\boxed{|a_2+1|<a_1}$\\
				\newline
				%\newpage
				On obtient alors le domaine de stabilité suivant :
						\begin{figure}[!h]
